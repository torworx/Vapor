...
public interface Connector extends Lifecycle {
    ...
    /**
     * @param port The port fto listen of for connections or 0 if any available port may be used.
     */
    ...
    void setZeroConf(boolean zeroConf);

    boolean isZeroConf();

    <T extends MessageDispatcher> Collection<T> getDispatchers();
