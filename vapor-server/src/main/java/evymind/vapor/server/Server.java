...
public class Server extends ServerInternalHandler implements Attributes {
	...
	/* ------------------------------------------------------------ */
	/**
	 * Add an associated bean. The bean will be added to the servers {@link Container} and if it is a {@link Lifecycle}
	 * instance, it will be started/stopped along with the Server. Any beans that are also {@link Destroyable}, will be
	 ...
	 * server. Instead, all {@link Connection}s will be closed so that new connections will not be accepted and all
