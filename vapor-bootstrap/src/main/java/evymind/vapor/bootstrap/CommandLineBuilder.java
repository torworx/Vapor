...
public class CommandLineBuilder {
	...
	/**
	 * Similar to {@link #addArg(String)} but concats both name + value with an "=" sign, quoting were needed, and
	 * excluding the "=" portion if the value is undefined or empty.
	 * <p>
	 * 
	 * <pre>
	 *   addEqualsArg("-Dname", "value") = "-Dname=value"
	 *   addEqualsArg("-Dvapor.home", "/opt/company inc/vapor (7)/") = "-Dvapor.home=/opt/company\ inc/vapor\ (7)/"
	 *   addEqualsArg("-Djenkins.workspace", "/opt/workspaces/vapor jdk7/") = "-Djenkins.workspace=/opt/workspaces/vapor\ jdk7/"
