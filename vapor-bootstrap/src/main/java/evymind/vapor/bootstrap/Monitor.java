...
/*-------------------------------------------*/
/**
 * Monitor thread. This thread listens on the port specified by the STOP.PORT system parameter (defaults to -1 for not
 * listening) for request authenticated with the key given by the STOP.KEY system parameter (defaults to "eclipse") for
 * admin requests.
 * <p>
