...
public interface VaporBuffer {
	 ...
	 *             if the specified {@code readerIndex} is less than {@code 0} or greater than {@code this.writerIndex}
	 */
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code writerIndex} is less than {@code this.readerIndex} or greater than
	 *             {@code this.capacity}
	 */
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code readerIndex} is less than 0, if the specified {@code writerIndex} is less
	 *             than the specified {@code readerIndex} or if the specified {@code writerIndex} is greater than
	 *             {@code this.capacity}
	 */
	 ...
	 * <p>
	 * Please note that the behavior of this method is different from that of NIO buffer, which sets the {@code limit}
	 * to the {@code capacity} of the buffer.
	 */
	void clear();
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the current {@code writerIndex} is less than the marked {@code readerIndex}
	 */
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the current {@code readerIndex} is greater than the marked {@code writerIndex}
	 */
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code index} is less than {@code 0} or {@code index + 1} is greater than
	 *             {@code this.capacity}
	 */
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code index} is less than {@code 0} or {@code index + 2} is greater than
	 *             {@code this.capacity}
	 */
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code index} is less than {@code 0} or {@code index + 4} is greater than
	 *             {@code this.capacity}
	 */
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code index} is less than {@code 0} or {@code index + 8} is greater than
	 *             {@code this.capacity}
	 */
	 ...
	 * {@link #getBytes(int, VaporBuffer, int, int)}, except that this method increases the {@code writerIndex} of the
	 * destination by the number of the transferred bytes while {@link #getBytes(int, VaporBuffer, int, int)} does not.
	 * This method does not modify {@code readerIndex} or {@code writerIndex} of the source buffer (i.e. {@code this}).
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code index} is less than {@code 0} or if {@code index + dst.writableBytes} is
	 *             greater than {@code this.capacity}
	 */
	void getBytes(int index, VaporBuffer dst);

	/**
	 * Transfers this buffer's data to the specified destination starting at the specified absolute {@code index}. This
	 * method is basically same with {@link #getBytes(int, VaporBuffer, int, int)}, except that this method increases the
	 * {@code writerIndex} of the destination by the number of the transferred bytes while
	 * {@link #getBytes(int, VaporBuffer, int, int)} does not. This method does not modify {@code readerIndex} or
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code index} is less than {@code 0}, if {@code index + length} is greater than
	 *             {@code this.capacity}, or if {@code length} is greater than {@code dst.writableBytes}
	 */
	void getBytes(int index, VaporBuffer dst, int length);
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code index} is less than {@code 0}, if the specified {@code dstIndex} is less than
	 *             {@code 0}, if {@code index + length} is greater than {@code this.capacity}, or if
	 *             {@code dstIndex + length} is greater than {@code dst.capacity}
	 */
	void getBytes(int index, VaporBuffer dst, int dstIndex, int length);
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code index} is less than {@code 0} or if {@code index + dst.length} is greater
	 ...
	 *             if the specified {@code index} is less than {@code 0}, if the specified {@code dstIndex} is less than
	 *             {@code 0}, if {@code index + length} is greater than {@code this.capacity}, or if
	 *             {@code dstIndex + length} is greater than {@code dst.length}
	 */
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code index} is less than {@code 0} or if {@code index + dst.remaining()} is
	 *             greater than {@code this.capacity}
	 */
	 ...
	 * until the destination becomes unreadable. This method is basically same with
	 * {@link #setBytes(int, VaporBuffer, int, int)}, except that this method increases the {@code readerIndex} of the
	 * source buffer by the number of the transferred bytes while {@link #getBytes(int, VaporBuffer, int, int)} does not.
	 * This method does not modify {@code readerIndex} or {@code writerIndex} of the source buffer (i.e. {@code this}).
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code index} is less than {@code 0} or if {@code index + src.readableBytes} is
	 *             greater than {@code this.capacity}
	 */
	void setBytes(int index, VaporBuffer src);

	/**
	 * Transfers the specified source buffer's data to this buffer starting at the specified absolute {@code index}.
	 * This method is basically same with {@link #setBytes(int, VaporBuffer, int, int)}, except that this method
	 ...
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code index} is less than {@code 0}, if {@code index + length} is greater than
	 *             {@code this.capacity}, or if {@code length} is greater than {@code src.readableBytes}
	 */
	void setBytes(int index, VaporBuffer src, int length);
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code index} is less than {@code 0}, if the specified {@code srcIndex} is less than
	 *             {@code 0}, if {@code index + length} is greater than {@code this.capacity}, or if
	 *             {@code srcIndex + length} is greater than {@code src.capacity}
	 */
	void setBytes(int index, VaporBuffer src, int srcIndex, int length);
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code index} is less than {@code 0} or if {@code index + src.length} is greater
	 *             than {@code this.capacity}
	 */
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code index} is less than {@code 0} or if {@code index + src.remaining()} is
	 *             greater than {@code this.capacity}
	 */
	...
	/**
	 * Gets a byte array at the current {@code readerIndex}
	 */
	byte[] readBinary();

	/**
	 * Gets a byte array at the current {@code readerIndex} and increases the readerIndex by the number of the
	 ...
	 *             if {@code length} is greater than {@code this.readableBytes}
	 */
	VaporBuffer readBytes(int length);
	 ...
	 *             if {@code length} is greater than {@code this.readableBytes}
	 */
	VaporBuffer readSlice(int length);
	 ...
	 * This method is basically same with {@link #readBytes(VaporBuffer, int, int)}, except that this method increases
	 * the {@code writerIndex} of the destination by the number of the transferred bytes while
	 * {@link #readBytes(VaporBuffer, int, int)} does not.
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if {@code dst.writableBytes} is greater than {@code this.readableBytes}
	 */
	void readBytes(VaporBuffer dst);
	 ...
	 * basically same with {@link #readBytes(VaporBuffer, int, int)}, except that this method increases the
	 * {@code writerIndex} of the destination by the number of the transferred bytes (= {@code length}) while
	 * {@link #readBytes(VaporBuffer, int, int)} does not.
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if {@code length} is greater than {@code this.readableBytes} or if {@code length} is greater than
	 *             {@code dst.writableBytes}
	 */
	void readBytes(VaporBuffer dst, int length);
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code dstIndex} is less than {@code 0}, if {@code length} is greater than
	 *             {@code this.readableBytes}, or if {@code dstIndex + length} is greater than {@code dst.capacity}
	 */
	void readBytes(VaporBuffer dst, int dstIndex, int length);
	 ...
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code dstIndex} is less than {@code 0}, if {@code length} is greater than
	 *             {@code this.readableBytes}, or if {@code dstIndex + length} is greater than {@code dst.length}
	 */
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if {@code dst.remaining()} is greater than {@code this.readableBytes}
	 */
	...
	/**
	 * Sets the specified double at the current {@code writerIndex} and increases the {@code writerIndex} by {@code 8}
	 * in this buffer.
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if {@code this.writableBytes} is less than {@code 8}
	 ...
	 * basically same with {@link #writeBytes(VaporBuffer, int, int)}, except that this method increases the
	 * {@code readerIndex} of the source buffer by the number of the transferred bytes (= {@code length}) while
	 * {@link #writeBytes(VaporBuffer, int, int)} does not.
	 * 
	 * @param length
	 *            the number of bytes to transfer
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if {@code length} is greater than {@code this.writableBytes} or if {@code length} is greater then
	 *             {@code src.readableBytes}
	 */
	void writeBytes(VaporBuffer src, int length);
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code srcIndex} is less than {@code 0}, if {@code srcIndex + length} is greater
	 *             than {@code src.capacity}, or if {@code length} is greater than {@code this.writableBytes}
	 */
	void writeBytes(VaporBuffer src, int srcIndex, int length);
	 ...
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code srcIndex} is less than {@code 0}, if {@code srcIndex + length} is greater
	 *             than {@code src.length}, or if {@code length} is greater than {@code this.writableBytes}
	 */
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if {@code src.remaining()} is greater than {@code this.writableBytes}
	 */
	 ...
	 */
	VaporBuffer copy(int index, int length);
	 ...
	 * {@code readerIndex} or {@code writerIndex} of this buffer.
	 */
	VaporBuffer slice(int index, int length);
	 ...
	 * to {@code buf.slice(0, buf.capacity())}. This method does not modify {@code readerIndex} or {@code writerIndex}
	 * of this buffer.
	 */
	VaporBuffer duplicate();
