 ...
 * Scanner
 * 
 * Utility for scanning a directory for added, removed and changed files and reporting these events via registered
 * Listeners.
 * 
 */
public class Scanner extends AbstractLifecycle {
	...
	/**
	 * Apply a filter to files found in the scan directory. Only files matching the filter will be reported as
	 * added/changed/removed.
	 * 
	 * @param filter
	 */
	 ...
	 *            file or directory
	 * @param scanInfoMap
	 *            map of filenames to last modified times
	 */
