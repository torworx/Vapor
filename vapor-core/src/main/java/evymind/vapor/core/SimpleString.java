...
public class SimpleString implements CharSequence, Serializable, Comparable<SimpleString> {
	...
	private static final long serialVersionUID = -5742409551458587811L;
	 ...
	 * parameter. If <code>string</code> is <code>null</code>, the return value
	 * will be <code>null</code> too.
	 */
	...
	/**
	 * Splits this SimpleString into an array of SimpleString using the char
	 * param as the delimiter. i.e. "a.b" would return "a" and "b" if . was the
	 * delimiter
	 * 
	 * @param delim
	 */
	 ...
	 * 
	 * @param toAdd
	 *            the SimpleString to concatenate with.
	 * @return the concatenated SimpleString
	 */
