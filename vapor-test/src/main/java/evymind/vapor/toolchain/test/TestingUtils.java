...
public final class TestingUtils {
	...
	public static File getTargetTestingDir(final Class<?> testclass, final String testmethodname) {
		...
		if (OS.IS_WINDOWS) {
			/*
			 * Condense the directory names to make them more friendly for the 255 character pathname limitations that
			 * exist on windows.
			 */
	...
	private static TestID getTestID() {
		...
		err.append(LN);
		err.append("Call to ").append(TestingUtils.class.getSimpleName());
