 ...
 * <p>
 * Similar in scope to the {@link TemporaryFolder} rule, as it creates a directory, when asked (via {@link #getDir()} or
	...
	public Statement apply(final Statement base, final Description description) {
		return new Statement() {
			...
			public void evaluate() throws Throwable {
				...
				dir = TestingUtils.getTargetTestingDir(description.getTestClass(), description.getMethodName());
				FS.ensureEmpty(dir);
				base.evaluate();
			}
		};
